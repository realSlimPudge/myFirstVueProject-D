...
<template>
    <div
        class="flex justify-center items-center w-screen h-[calc(100vh_-_60px)]"
    >
        <div class="flex items-center gap-x-10">
            <h2 class="text-5xl text-slate-50 text-right">
                Hello, we are a
                <br />
                <span class="text-[#6C63FF] font-semibold"
                    >internet online-shop</span
                >
            </h2>
            <div class="w-[650px]">
                <svg
